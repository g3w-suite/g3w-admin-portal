<template>
  <dialog id="credits-modal" ref="dialog" data-theme="light">
...
@Component
export default class DialogCredits extends Vue {

  public mounted() {
    dialogPolyfill.registerDialog((this.$refs as any).dialog);
  }

  public showModal() {
    (this.$refs as any).dialog.showModal();
  }
